...
from step5_web_optimize.validation import validate_web_optimize_output, validate_step_input, ValidationError
...
class WebOptimizer:
    ...
    def validate_optimized_glb(self) -> bool:
        ...
        try:
            ...
            # Use step-specific validation system for final GLB
            input_type = validation_config.get('input_type', 'glb')
            if isinstance(input_type, str):
                validate_step_input(self.input_glb_path, input_type)
            validate_web_optimize_output(self.output_glb_path, validation_config)
