...
Data structures and models for the comprehensive Step 1 validation plan.
Each model represents the output of a specific validation sub-task.
"""
...
class ValidationResult:
    ...
    @classmethod
    def success_result(cls, data: Any) -> 'ValidationResult':
...
# Required MetaHuman plugins for validation
